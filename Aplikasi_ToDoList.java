...
public class Aplikasi_ToDoList {
    ...
    public static void testShowTodoList(){
        ...
        model[1] = "Studi Kasus Java dasar : Aplikasi ToidoList";
         showTodoList();
    }
    ...
    public static void viewRemoveTodoList()      {  
        ...
        String number = input("Nomor Yang Dihaapus (x Jika Batal)");
        ...
        //batal
            ...
            if (!success){
                System.out.println("Gagal Menghapous TodoList : + number");
            }
        }
    }
    public static void viewAddTodoList() {
